...
<body id="page-top">
   ...
   <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #000;">
    ...
    <header class="masthead text-white position-relative" style="height: 100vh; overflow: hidden;">
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="assets/img/01.png" alt="Tracking meat inventory" /></div>
                </div>
...
<p>Inventory ensures consistent quality across your beef, lamb, and chicken inventory. Track sourcing, processing, and handling to deliver meat your customers can trust.</p>
    ...
    <section>
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="assets/img/02.png" alt="Monitoring storage conditions" /></div>
                </div>
                <div class="col-lg-6">
                    <div class="p-5">
...
<p>Maintain the highest meat standards with real-time monitoring of cold chain conditions. Inventory Moto helps you guarantee freshness and safety for every cut of beef, lamb, and chicken.</p>
    ...
    <section>
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img class="img-fluid rounded-circle" src="assets/img/03.png" alt="Loss recording and analytics" /></div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="p-5">
                        <h2 class="display-5">Protecting Quality. Building Trust.</h2>
<p>Monitor and minimize post-harvest losses while maintaining peak meat quality. Record incidents, analyze trends, and act fast to preserve trust and reduce spoilage in beef, lamb, and chicken products.</p>
